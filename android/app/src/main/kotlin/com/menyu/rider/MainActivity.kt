package com.menyu.mennyu_rider
...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(binaryMessenger, "com.menyu/background_service").apply {
        ...
        MethodChannel(binaryMessenger, "com.menyu/app_retain").apply {
            setMethodCallHandler { method, result ->
