...
import 'package:mennyu_rider/data/model/body/record_location_body.dart';
import 'package:mennyu_rider/data/model/body/update_status_body.dart';
import 'package:mennyu_rider/data/model/response/ignore_model.dart';
import 'package:mennyu_rider/data/model/response/order_details_model.dart';
...
class OrderController extends GetxController implements GetxService {
  ...
  Future<bool> updateOrderStatus(int index, String status) async {
    _isLoading = true;
    update();
